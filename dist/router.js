...
import { createProduct, deleteProduct, getProduct, getProducts } from "./handlers/product.js";
...
router.put("/update/:id", body("title").optional().isString(), body("body").optional().isString(), body("status").optional().isIn(['IN_PROGRESS', 'LIVE', 'DEPRECATED', 'ARCHIVED']), body("version").optional().isString(), handleInputErrors, asyncHandler(updateUpdate));
router.post("/update", body("title").isString(), body("body").isString(), body("productId").isString(), handleInputErrors, asyncHandler(createUpdate));
...
router.post("/updatepoint", body("name").isString(), body("description").isString(), body("updateId").isString(), handleInputErrors, (req, res) => {
